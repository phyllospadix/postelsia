...
```{r popchangejun-aug, fig.width = 6,  fig.height = 5, fig.cap="Decline in population size between June and August.", message=F, warning=F, include =TRUE}
...
popJA +
  labs(x = "population size in June (2007, 2008, 2009)") +
  labs(y = "population size in August (2007, 2008, 2009)") +
  #labs(title= "Populations get smaller over the summer (~by half)")+
  labs(subtitle = "August population size = 43 + 0.53 x June population size, r2 = 0.86")
...
```{r diam-dw-fig, fig.width = 5,  fig.height = 5, fig.cap=" Relationship between *Postelsia* biomass and stipe diameter", message=FALSE, include=TRUE}
...
```{r barplots, fig.width = 3,  fig.height = 8, fig.cap="Biologically Effective Upwelling Transport Index (BEUTI) for 2007, 2008, and 2009.", Include=T }
