...
my_packages <- c("knitr", "renv", "easypackages", "here", "ggthemes", "gridExtra", "tidyverse", "lubridate", "patchwork", "readxl", "survival", "survminer", "ranger", "condSURV", "ggplot2", "gtsummary", "flextable", "dplyr", "forcats", "bookdown", "googledrive", "googlesheets4") 
...
#fit the model
summermodel <- lm(post_pop$aug~ post_pop$june)
...
popJA <- ggplot(post_pop, aes(x=june, y=aug)) +
  geom_point( size=2, color ="seagreen") +
  geom_smooth(method=lm, se=TRUE) +
  theme_few() 
